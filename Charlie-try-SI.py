# -*- coding: utf-8 -*-
"""
Created on Thu Mar  8 17:06:24 2018
...
'''
def f(n):
    return (rho[0] - 236*n**(2.54) - n*MNEUTRON)
    root = optimize.newton(f,5000000)
    print(root)
'''
...
def DensityToPressure(n):
    P = (363.44 * n**2.54)*((1.6*10*-13)*(10**45))
...
#P.append(DensityToPressure(rho[0]))
#P.append(500)
for i in range(1,10):
        ...
        rho.append(PressureToDensity(P1))
