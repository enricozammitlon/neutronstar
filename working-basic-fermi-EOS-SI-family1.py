...
for rhoIn in family:
  ...
  def PressureToDensity3(Pressure):
    Pressure=(Pressure*1e-45)/(1.602e-13)
    #P = 363.44 * n**2.54
    n = (Pressure/363.44)**(1/2.54)
    density = 236*(n**2.54) +n*MNEUTRON
    density=(density*1.602e-13)/(1e-45*c**2)
    return density

  def DensityToPressure3(rho):
    rho=(rho*1e-45*c**2)/(1.602e-13)
    n=optimize.newton(lambda x: rho-236*(x**(2.54))-x*MNEUTRON,1e2)
    P = 363.44 * (n**2.54)
    P = (P*1.602e-13)/(1e-45)
